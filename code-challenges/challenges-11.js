...
function square(arr) {
    ...
    const numSquare = arr.map(item => item * item)
...
function fullName(arr) {
    // write your code here
    let nameArray = arr.map(item => item.firstName + " " + item.lastName)
...
function gradesAvg(arr) {
    // write your code here
    let grades = arr.map(item => item.avg = item.gradsList.reduce((a, b) => a + b, 0) / item.gradsList)
    return grades;
}
// -------------------------------------------------------------------------------------------------------
