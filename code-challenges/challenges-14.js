...
const replaceWords = (str) => {
    // write your code here
    let myArr = str.split(" ");
    let indexOfI = myArr.indexOf("I");
    if(indexOfI >= 0){
        myArr.splice(indexOfI,1,"We");
    }
    let indexOfAm = myArr.indexOf("am");
    if(indexOfAm >= 0){
        myArr.splice(indexOfAm,1,"are");
    }
    let indexOfWas = myArr.indexOf("was");
    if(indexOfWas >= 0){
        myArr.splice(indexOfWas,1,"were");
    }
